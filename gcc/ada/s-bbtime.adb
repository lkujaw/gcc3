...
package body System.BB.Time is
   ...
   --
   --  pragma Atomic (MSP_Clock) is needed because MSP_Clock is updated by
   --  Clock_Handler.
   ...
   --  to the two 32-bit parts separately.
   ...
   begin
      ...
      pragma Assert
        (Pending_Alarm and Interrupt = Peripherals.General_Purpose_Timer);
   ...
   begin
      ...
      pragma Assert (Interrupt = Peripherals.Real_Time_Clock);
      ...
      --  The clock timer has finished counting 2**32 hardware clock ticks
   ...
   begin
      ...
      Interrupts.Attach_Handler
        (Clock_Handler'Access, Peripherals.Real_Time_Clock);

      --  Install timer handler

      Interrupts.Attach_Handler
        (Alarm_Handler'Access, Peripherals.General_Purpose_Timer);
