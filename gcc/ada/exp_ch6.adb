   ...
   begin
      Obj_Address :=
        Make_Attribute_Reference
          (Loc, Return_Object, Name_Unrestricted_Access);
...
--         end if;
   ...
   procedure Freeze_Subprogram (N : Node_Id) is
      ...
      procedure Register_Interface_DT_Entry (Prim : Entity_Id);
      ...
      procedure Register_Interface_DT_Entry (Prim : Entity_Id) is
         Iface_Typ  : Entity_Id;
      ...
      begin
         ...
         --  Generate the code of the thunk only if the abstract interface
         --  type is not an immediate ancestor of Tagged_Type; otherwise the
         --  dispatch table associated with the interface is the primary
         --  dispatch table.
      ...
      Add_Access_Actual_To_Build_In_Place_Call
        (Func_Call,
         ...
         Make_Explicit_Dereference
           (Loc, New_Reference_To (Return_Obj_Access, Loc)));
   ...
   begin
      ...
      Add_Access_Actual_To_Build_In_Place_Call
        (Func_Call,
         Function_Id,
         New_Reference_To (Defining_Identifier (Object_Decl), Loc));
