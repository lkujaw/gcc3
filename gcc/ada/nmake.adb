...
package body Nmake is
   ...
   function Make_Extended_Return_Statement (Sloc : Source_Ptr;
      Return_Object_Declarations   : List_Id;
      Handled_Statement_Sequence   : Node_Id := Empty)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Extended_Return_Statement, Sloc);
   begin
      Set_Return_Object_Declarations (N, Return_Object_Declarations);
      Set_Handled_Statement_Sequence (N, Handled_Statement_Sequence);
      return N;
   end Make_Extended_Return_Statement;
   ...
   function Make_Formal_Object_Declaration (Sloc : Source_Ptr;
      ...
      Subtype_Mark                 : Node_Id := Empty;
      Access_Definition            : Node_Id := Empty;
      Default_Expression           : Node_Id := Empty)
      return Node_Id
   is
      N : constant Node_Id :=
   ...
   begin
      ...
      Set_Subtype_Mark (N, Subtype_Mark);
      Set_Access_Definition (N, Access_Definition);
      Set_Default_Expression (N, Default_Expression);
      return N;
