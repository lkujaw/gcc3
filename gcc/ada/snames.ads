...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_All_Checks                     : constant Name_Id := N + 514;
   Last_Check_Name                     : constant Name_Id := N + 514;

   --  Names corresponding to reserved keywords, excluding those already
   --  declared in the attribute list (Access, Delta, Digits, Mod, Range).

   Name_Abort                          : constant Name_Id := N + 515;
   Name_Abs                            : constant Name_Id := N + 516;
   Name_Accept                         : constant Name_Id := N + 517;
   Name_And                            : constant Name_Id := N + 518;
   Name_All                            : constant Name_Id := N + 519;
   Name_Array                          : constant Name_Id := N + 520;
   Name_At                             : constant Name_Id := N + 521;
   Name_Begin                          : constant Name_Id := N + 522;
   Name_Body                           : constant Name_Id := N + 523;
   Name_Case                           : constant Name_Id := N + 524;
   Name_Constant                       : constant Name_Id := N + 525;
   Name_Declare                        : constant Name_Id := N + 526;
   Name_Delay                          : constant Name_Id := N + 527;
   Name_Do                             : constant Name_Id := N + 528;
   Name_Else                           : constant Name_Id := N + 529;
   Name_Elsif                          : constant Name_Id := N + 530;
   Name_End                            : constant Name_Id := N + 531;
   Name_Entry                          : constant Name_Id := N + 532;
   Name_Exception                      : constant Name_Id := N + 533;
   Name_Exit                           : constant Name_Id := N + 534;
   Name_For                            : constant Name_Id := N + 535;
   Name_Function                       : constant Name_Id := N + 536;
   Name_Generic                        : constant Name_Id := N + 537;
   Name_Goto                           : constant Name_Id := N + 538;
   Name_If                             : constant Name_Id := N + 539;
   Name_In                             : constant Name_Id := N + 540;
   Name_Is                             : constant Name_Id := N + 541;
   Name_Limited                        : constant Name_Id := N + 542;
   Name_Loop                           : constant Name_Id := N + 543;
   Name_New                            : constant Name_Id := N + 544;
   Name_Not                            : constant Name_Id := N + 545;
   Name_Null                           : constant Name_Id := N + 546;
   Name_Of                             : constant Name_Id := N + 547;
   Name_Or                             : constant Name_Id := N + 548;
   Name_Others                         : constant Name_Id := N + 549;
   Name_Out                            : constant Name_Id := N + 550;
   Name_Package                        : constant Name_Id := N + 551;
   Name_Pragma                         : constant Name_Id := N + 552;
   Name_Private                        : constant Name_Id := N + 553;
   Name_Procedure                      : constant Name_Id := N + 554;
   Name_Raise                          : constant Name_Id := N + 555;
   Name_Record                         : constant Name_Id := N + 556;
   Name_Rem                            : constant Name_Id := N + 557;
   Name_Renames                        : constant Name_Id := N + 558;
   Name_Return                         : constant Name_Id := N + 559;
   Name_Reverse                        : constant Name_Id := N + 560;
   Name_Select                         : constant Name_Id := N + 561;
   Name_Separate                       : constant Name_Id := N + 562;
   Name_Subtype                        : constant Name_Id := N + 563;
   Name_Task                           : constant Name_Id := N + 564;
   Name_Terminate                      : constant Name_Id := N + 565;
   Name_Then                           : constant Name_Id := N + 566;
   Name_Type                           : constant Name_Id := N + 567;
   Name_Use                            : constant Name_Id := N + 568;
   Name_When                           : constant Name_Id := N + 569;
   Name_While                          : constant Name_Id := N + 570;
   Name_With                           : constant Name_Id := N + 571;
   Name_Xor                            : constant Name_Id := N + 572;
   ...
   First_Intrinsic_Name                 : constant Name_Id := N + 573;
   Name_Divide                          : constant Name_Id := N + 573;
   Name_Enclosing_Entity                : constant Name_Id := N + 574;
   Name_Exception_Information           : constant Name_Id := N + 575;
   Name_Exception_Message               : constant Name_Id := N + 576;
   Name_Exception_Name                  : constant Name_Id := N + 577;
   Name_File                            : constant Name_Id := N + 578;
   Name_Generic_Dispatching_Constructor : constant Name_Id := N + 579;
   Name_Import_Address                  : constant Name_Id := N + 580;
   Name_Import_Largest_Value            : constant Name_Id := N + 581;
   Name_Import_Value                    : constant Name_Id := N + 582;
   Name_Is_Negative                     : constant Name_Id := N + 583;
   Name_Line                            : constant Name_Id := N + 584;
   Name_Rotate_Left                     : constant Name_Id := N + 585;
   Name_Rotate_Right                    : constant Name_Id := N + 586;
   Name_Shift_Left                      : constant Name_Id := N + 587;
   Name_Shift_Right                     : constant Name_Id := N + 588;
   Name_Shift_Right_Arithmetic          : constant Name_Id := N + 589;
   Name_Source_Location                 : constant Name_Id := N + 590;
   Name_Unchecked_Conversion            : constant Name_Id := N + 591;
   Name_Unchecked_Deallocation          : constant Name_Id := N + 592;
   Name_To_Pointer                      : constant Name_Id := N + 593;
   Last_Intrinsic_Name                  : constant Name_Id := N + 593;

   --  Names used in processing intrinsic calls

   Name_Free                           : constant Name_Id := N + 594;

   --  Reserved words used only in Ada 95

   First_95_Reserved_Word              : constant Name_Id := N + 595;
   Name_Abstract                       : constant Name_Id := N + 595;
   Name_Aliased                        : constant Name_Id := N + 596;
   Name_Protected                      : constant Name_Id := N + 597;
   Name_Until                          : constant Name_Id := N + 598;
   Name_Requeue                        : constant Name_Id := N + 599;
   Name_Tagged                         : constant Name_Id := N + 600;
   Last_95_Reserved_Word               : constant Name_Id := N + 600;
   ...
   Name_Raise_Exception                : constant Name_Id := N + 601;

   --  Additional reserved words and identifiers used in GNAT Project Files
   --  Note that Name_External is already previously declared

   Name_Ada_Roots                      : constant Name_Id := N + 602;
   Name_Archive_Builder                : constant Name_Id := N + 603;
   Name_Archive_Indexer                : constant Name_Id := N + 604;
   Name_Binder                         : constant Name_Id := N + 605;
   Name_Binder_Driver                  : constant Name_Id := N + 606;
   Name_Body_Suffix                    : constant Name_Id := N + 607;
   Name_Builder                        : constant Name_Id := N + 608;
   Name_Compiler                       : constant Name_Id := N + 609;
   Name_Compiler_Driver                : constant Name_Id := N + 610;
   Name_Compiler_Kind                  : constant Name_Id := N + 611;
   Name_Compiler_Pic_Option            : constant Name_Id := N + 612;
   Name_Compute_Dependency             : constant Name_Id := N + 613;
   Name_Config_Body_File_Name          : constant Name_Id := N + 614;
   Name_Config_Body_File_Name_Pattern  : constant Name_Id := N + 615;
   Name_Config_File_Switches           : constant Name_Id := N + 616;
   Name_Config_File_Unique             : constant Name_Id := N + 617;
   Name_Config_Spec_File_Name          : constant Name_Id := N + 618;
   Name_Config_Spec_File_Name_Pattern  : constant Name_Id := N + 619;
   Name_Cross_Reference                : constant Name_Id := N + 620;
   Name_Default_Builder_Switches       : constant Name_Id := N + 621;
   Name_Default_Global_Compiler_Switches : constant Name_Id := N + 622;
   Name_Default_Language               : constant Name_Id := N + 623;
   Name_Default_Linker                 : constant Name_Id := N + 624;
   Name_Default_Switches               : constant Name_Id := N + 625;
   Name_Dependency_File_Kind           : constant Name_Id := N + 626;
   Name_Dependency_Option              : constant Name_Id := N + 627;
   Name_Exec_Dir                       : constant Name_Id := N + 628;
   Name_Executable                     : constant Name_Id := N + 629;
   Name_Executable_Suffix              : constant Name_Id := N + 630;
   Name_Extends                        : constant Name_Id := N + 631;
   Name_Externally_Built               : constant Name_Id := N + 632;
   Name_Finder                         : constant Name_Id := N + 633;
   Name_Global_Compiler_Switches       : constant Name_Id := N + 634;
   Name_Global_Configuration_Pragmas   : constant Name_Id := N + 635;
   Name_Gnatls                         : constant Name_Id := N + 636;
   Name_Gnatstub                       : constant Name_Id := N + 637;
   Name_Implementation                 : constant Name_Id := N + 638;
   Name_Implementation_Exceptions      : constant Name_Id := N + 639;
   Name_Implementation_Suffix          : constant Name_Id := N + 640;
   Name_Include_Option                 : constant Name_Id := N + 641;
   Name_Include_Path                   : constant Name_Id := N + 642;
   Name_Include_Path_File              : constant Name_Id := N + 643;
   Name_Language_Kind                  : constant Name_Id := N + 644;
   Name_Language_Processing            : constant Name_Id := N + 645;
   Name_Languages                      : constant Name_Id := N + 646;
   Name_Library_Ali_Dir                : constant Name_Id := N + 647;
   Name_Library_Dir                    : constant Name_Id := N + 648;
   Name_Library_Auto_Init              : constant Name_Id := N + 649;
   Name_Library_GCC                    : constant Name_Id := N + 650;
   Name_Library_Interface              : constant Name_Id := N + 651;
   Name_Library_Kind                   : constant Name_Id := N + 652;
   Name_Library_Name                   : constant Name_Id := N + 653;
   Name_Library_Options                : constant Name_Id := N + 654;
   Name_Library_Reference_Symbol_File  : constant Name_Id := N + 655;
   Name_Library_Src_Dir                : constant Name_Id := N + 656;
   Name_Library_Symbol_File            : constant Name_Id := N + 657;
   Name_Library_Symbol_Policy          : constant Name_Id := N + 658;
   Name_Library_Version                : constant Name_Id := N + 659;
   Name_Linker                         : constant Name_Id := N + 660;
   Name_Linker_Executable_Option       : constant Name_Id := N + 661;
   Name_Linker_Lib_Dir_Option          : constant Name_Id := N + 662;
   Name_Linker_Lib_Name_Option         : constant Name_Id := N + 663;
   Name_Local_Configuration_Pragmas    : constant Name_Id := N + 664;
   Name_Locally_Removed_Files          : constant Name_Id := N + 665;
   Name_Mapping_File_Switches          : constant Name_Id := N + 666;
   Name_Metrics                        : constant Name_Id := N + 667;
   Name_Naming                         : constant Name_Id := N + 668;
   Name_Object_Dir                     : constant Name_Id := N + 669;
   Name_Pretty_Printer                 : constant Name_Id := N + 670;
   Name_Project                        : constant Name_Id := N + 671;
   Name_Roots                          : constant Name_Id := N + 672;
   Name_Runtime_Project                : constant Name_Id := N + 673;
   Name_Separate_Suffix                : constant Name_Id := N + 674;
   Name_Source_Dirs                    : constant Name_Id := N + 675;
   Name_Source_Files                   : constant Name_Id := N + 676;
   Name_Source_List_File               : constant Name_Id := N + 677;
   Name_Spec                           : constant Name_Id := N + 678;
   Name_Spec_Suffix                    : constant Name_Id := N + 679;
   Name_Specification                  : constant Name_Id := N + 680;
   Name_Specification_Exceptions       : constant Name_Id := N + 681;
   Name_Specification_Suffix           : constant Name_Id := N + 682;
   Name_Switches                       : constant Name_Id := N + 683;

   --  Other miscellaneous names used in front end

   Name_Unaligned_Valid                : constant Name_Id := N + 684;

   --  Ada 2005 reserved words

   First_2005_Reserved_Word            : constant Name_Id := N + 685;
   Name_Interface                      : constant Name_Id := N + 685;
   Name_Overriding                     : constant Name_Id := N + 686;
   Name_Synchronized                   : constant Name_Id := N + 687;
   Last_2005_Reserved_Word             : constant Name_Id := N + 687;
   ...
   Last_Predefined_Name                : constant Name_Id := N + 687;
