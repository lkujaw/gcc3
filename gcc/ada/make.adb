   ...
   begin
      ...
      --  If we have seen a regular switch process it
         ...
         --  step are not executed.
            ...
            --  character switches which are not in 'a' .. 'z' (except 'C',
            --  'F', 'M' and 'B') are passed to the compiler, unless we are
            --  dealing with a debug switch (starts with 'd') or an extended
            --  gnatmake switch (starts with 'e').
