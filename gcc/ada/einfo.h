...
/*--------------------------------------------------------------------------*/
   ...
   #define E_Incomplete_Subtype             51
   #define E_Task_Type                      52
   #define E_Task_Subtype                   53
   #define E_Protected_Type                 54
   #define E_Protected_Subtype              55
   #define E_Exception_Type                 56
   #define E_Subprogram_Type                57
   #define E_Enumeration_Literal            58
   #define E_Function                       59
   #define E_Operator                       60
   #define E_Procedure                      61
   #define E_Entry                          62
   #define E_Entry_Family                   63
   #define E_Block                          64
   #define E_Entry_Index_Parameter          65
   #define E_Exception                      66
   #define E_Generic_Function               67
   #define E_Generic_Procedure              68
   #define E_Generic_Package                69
   #define E_Label                          70
   #define E_Loop                           71
   #define E_Return_Statement               72
   #define E_Package                        73
   #define E_Package_Body                   74
   #define E_Protected_Object               75
   #define E_Protected_Body                 76
   #define E_Task_Body                      77
   #define E_Subprogram_Body                78
   ...
   #define Is_Inherently_Limited_Type einfo__is_inherently_limited_type
   B Is_Inherently_Limited_Type         (E Id);
