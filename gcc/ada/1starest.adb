...
--  for use with the ravenscar/HI-E profile.
...
package body System.Tasking.Restricted.Stages is
   ...
   --  Return the address of the task specific secondary stack, as expected
   --  by System.Secondary_Stack
